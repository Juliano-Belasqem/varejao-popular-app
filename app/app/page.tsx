      ...
      <section className="grid" style={{ marginTop: 18 }}>
        <div className="card">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,minmax(0,1fr))", gap: 10 }}>
            <Link href="/app/publicacoes?status=draft" style={{ textDecoration: "none", color: "inherit", border: "1px solid #e5e7eb", borderRadius: 12, padding: 12 }}>
              <div className="muted">Rascunhos</div><strong style={{ fontSize: 24 }}>{drafts.count ?? 0}</strong>
            </Link>
            <Link href="/app/publicacoes?status=error" style={{ textDecoration: "none", color: "inherit", border: "1px solid #e5e7eb", borderRadius: 12, padding: 12 }}>
              <div className="muted">Com erro</div><strong style={{ fontSize: 24 }}>{errors.count ?? 0}</strong>
            </Link>
            <Link href="/app/publicacoes?status=published" style={{ textDecoration: "none", color: "inherit", border: "1px solid #e5e7eb", borderRadius: 12, padding: 12 }}>
              <div className="muted">Publicadas</div><strong style={{ fontSize: 24 }}>{published.count ?? 0}</strong>
            </Link>
          </div>
          {(errors.count ?? 0) > 0 && (
